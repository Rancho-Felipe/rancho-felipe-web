...
export type AddOnWhereInput = {
  ...
  note?: Prisma.StringNullableFilter<"AddOn"> | string | null
  price?: Prisma.IntFilter<"AddOn"> | number
  packages?: Prisma.EnumPackageKeyNullableListFilter<"AddOn">
  unitIds?: Prisma.StringNullableListFilter<"AddOn">
  payOnSite?: Prisma.BoolFilter<"AddOn"> | boolean
...
export type AddOnScalarWhereWithAggregatesInput = {
  ...
  note?: Prisma.StringNullableWithAggregatesFilter<"AddOn"> | string | null
  price?: Prisma.IntWithAggregatesFilter<"AddOn"> | number
  packages?: Prisma.EnumPackageKeyNullableListFilter<"AddOn">
  unitIds?: Prisma.StringNullableListFilter<"AddOn">
  payOnSite?: Prisma.BoolWithAggregatesFilter<"AddOn"> | boolean
...
export type AddOnCreateInput = {
  ...
  note?: string | null
  price: number
  packages?: Prisma.AddOnCreatepackagesInput | $Enums.PackageKey[]
  unitIds?: Prisma.AddOnCreateunitIdsInput | string[]
  payOnSite?: boolean
  active?: boolean
  sortOrder?: number
...
export type AddOnUpdateInput = {
  ...
  packages?: Prisma.AddOnUpdatepackagesInput | $Enums.PackageKey[]
  unitIds?: Prisma.AddOnUpdateunitIdsInput | string[]
  payOnSite?: Prisma.BoolFieldUpdateOperationsInput | boolean
...
export type EnumPackageKeyNullableListFilter<$PrismaModel = never> = {
  equals?: $Enums.PackageKey[] | Prisma.ListEnumPackageKeyFieldRefInput<$PrismaModel> | null
  has?: $Enums.PackageKey | Prisma.EnumPackageKeyFieldRefInput<$PrismaModel> | null
  hasEvery?: $Enums.PackageKey[] | Prisma.ListEnumPackageKeyFieldRefInput<$PrismaModel>
  hasSome?: $Enums.PackageKey[] | Prisma.ListEnumPackageKeyFieldRefInput<$PrismaModel>
  isEmpty?: boolean
}
...
export type AddOnCreatepackagesInput = {
  set: $Enums.PackageKey[]
}

export type AddOnCreateunitIdsInput = {
  set: string[]
}

export type AddOnUpdatepackagesInput = {
  set?: $Enums.PackageKey[]
  push?: $Enums.PackageKey | $Enums.PackageKey[]
}

export type AddOnUpdateunitIdsInput = {
  set?: string[]
  push?: string | string[]
}
...
export type AddOnOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "name" | "note" | "price" | "packages" | "unitIds" | "payOnSite" | "active" | "sortOrder", ExtArgs["result"]["addOn"]>
...
export interface AddOnFieldRefs {
  ...
  readonly note: Prisma.FieldRef<"AddOn", 'String'>
  readonly price: Prisma.FieldRef<"AddOn", 'Int'>
  readonly packages: Prisma.FieldRef<"AddOn", 'PackageKey[]'>
  readonly unitIds: Prisma.FieldRef<"AddOn", 'String[]'>
  readonly payOnSite: Prisma.FieldRef<"AddOn", 'Boolean'>
