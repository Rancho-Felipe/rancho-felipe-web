...
export const HOTSPOTS: Hotspot[] = [
  ...
  { id: 'function-area', label: 'Function area', photo: 'grounds-function-area-stage', blurb: 'Turfed area with a low stage and banquet seating.', x: 250, y: 386, zone: 'shared' },
  ...
  { id: 'gazebo-rooms', label: 'Gazebo rooms', photo: 'collage-gazebo-room-1', blurb: 'Two air-conditioned rooms with bunks, smart TV and videoke.', x: 250, y: 512, zone: 'gazebo' },
  ...
  { id: 'gazebo-cr', label: 'Comfort rooms', photo: 'gazebo-comfort-room', blurb: 'Tiled shower and toilet at the gazebo.', x: 388, y: 512, zone: 'gazebo' },
...
export function PlanArtwork({ dimZone }: { dimZone?: (zone: 'casita' | 'gazebo') => boolean }) {
  ...
  return (
    <g>
      ...
      {/* function area with its low stage */}
      <rect x="200" y="352" width="100" height="66" rx="4" fill="var(--color-field)" opacity="0.7" />
      <rect x="228" y="404" width="44" height="12" rx="2" fill="var(--color-stone)" opacity="0.7" />
      ...
      <g opacity={gazeboDim ? 0.32 : 1}>
        {/* the long building with the mural, doors facing the pool */}
        <rect x="160" y="486" width="270" height="52" rx="4" fill="#3d4436" stroke="var(--color-night)" strokeWidth="2" />
        {[196, 246, 296, 346, 396].map((x) => (
        ...
        {/* comfort rooms at the eastern end */}
        <rect x="368" y="486" width="62" height="52" rx="4" fill="var(--color-stone)" opacity="0.35" />
      </g>
    </g>
  )
}
